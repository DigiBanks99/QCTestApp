...
set _DeploySetParametersFile=%RootPath%QCTestFE.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%QCTestFE.zip" (
echo "%RootPath%QCTestFE.zip" does not exist. 
...
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%QCTestFE.zip',EncryptPassword='people' -dest:%_Destination%,EncryptPassword='people' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension
) else (
set _MSDeployCommandline="%MSDeployPath%msdeploy.exe" -source:package='%RootPath%QCTestFE.zip',EncryptPassword='people' -dest:%_Destination%,EncryptPassword='people' -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%_DeploySetParametersFile%"
)
...
:usage
echo =========================================================
if not exist "%RootPath%QCTestFE.deploy-readme.txt" (
...
start notepad "%RootPath%QCTestFE.deploy-readme.txt"
)
echo =========================================================
goto :eof
